...
CLASS_ICONS_DIR = os.path.join(os.path.dirname(__file__), "class-icons")
SPEC_ICONS_DIR = os.path.join(os.path.dirname(__file__), "class-spec-icons")
...
if __name__ == "__main__":
    import sys
    img_path = sys.argv[1] if len(sys.argv) > 1 else "../../example-images/image.png"
